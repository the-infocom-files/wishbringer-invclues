...
<OBJECT STOCK
	(LOC INSIDE-SHOPPE)
	(DESC "magic tricks")
	(SYNONYM TRICK TRICKS PUZZLE PARAPHENALIA)
...
<OBJECT ENVELOPE
	...
	(SYNONYM ENVELOPE MAIL LETTER ADDRESS)
      ...
      North Festeron, Antharia" CR>
		...
		<COND (<DONT-HAVE? ,ENVELOPE>
		      ...
		      ;<SETG L-PRSO ,OPEN-ENVELOPE>
		       ...
		       <TELL 
"Opening the " D ,ENVELOPE " reveals a letter." CR>
		       <RTRUE>)>
		<TELL
"You flush with shame at the mere thought of opening somebody else's personal mail." CR>
		<RTRUE>)
	       (<AND <VERB? TAKE>
...
; <OBJECT STAMP
	(LOC ENVELOPE)
	(DESC "cancelled stamp")
	(SYNONYM STAMP)
	(ADJECTIVE CANCELLED PLATYPUS)
	(ACTION STAMP-F)
...
; <ROUTINE STAMP-F ()
	 <COND (<VERB? EXAMINE READ>
	        <TELL 
"The motto \"E Platypus Unum\" is inscribed below a drawing of an appropriately somber monotreme." CR>
		<RTRUE>)
	       (<MOVING? ,STAMP>
		<TELL "The stamp is permanently glued to the envelope." CR>
		<RTRUE>)
	       (<HURT? ,STAMP>
		<HOW-WOULD-YOU-LIKE-IT ,STAMP>
		<RTRUE>)
	       (T
		<RFALSE>)>>
...
" ambles back into the " D ,MAGICK-SHOPPE ". \"Farewell!\" she calls from the closing door, and the sunlight makes her face look young. \"Now you are a true Adventurer.\"" CR CR>
			      ...
			      <CARRIAGE-RETURNS>
			      <TELL
"Congratulations! You've finished the story of ">
			      <HLIGHT ,H-ITALIC>
			      <TELL ,GAME>
			      <HLIGHT ,H-NORMAL>
			      <TELL "!" CR CR>
