...
<OBJECT ART
	...
	(SYNONYM PAINTING PAINTINGS PICTURE SERIES SEQUENCE)
...
<OBJECT COAT
	...
	(ADJECTIVE WHITE POCKET LAB LABORATORY DIRTY COLLAR)
...
<OBJECT LABORATORY
	...
	(NORTH SORRY "The only north exit is through the window.")
	(OUT PER EXIT-LAB)
	(DOWN PER EXIT-LAB)
	(ACTION LABORATORY-F)
...
<ROUTINE IMAGE? (THING)
	 <COND (<EQUAL? ,HERE ,INSIDE-THEATER>
		<COND (<AND <VERB? THROW>
			    <EQUAL? ,PRSI .THING>>
		       <PERFORM ,V?THROW ,PRSO ,MOVIE-SCREEN>)
		      (T
		       <TELL ,CANT>
		       <DO-TO>
