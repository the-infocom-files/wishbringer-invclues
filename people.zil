...
" with her bony fingers and hands you a " D ,TICKET ".">
		      ...
		      (<EQUAL? ,PRSO ,BOOK>
		       <COND (,SKEWED?
			      <TELL 
"\"Sentimental garbage. Try my new book, ">
			      <COND (<EQUAL? ,HOST ,MACINTOSH>
				     <TELL 
"99 WAYS TO DE-TICK YOUR HELLHOUND">)
				    (T
				     <HLIGHT ,H-ITALIC>
				     <TELL 
"99 Ways To De-Tick Your Hellhound">
			      ...
			      <TELL ".\"" CR>
			      <RTRUE>)>
		       <TELL "\"No time for autographs now, dear.\"" CR>
		       <RTRUE>)
		      (T
...
<CONSTANT POWER-WORDS <PTABLE "KALUZE" "FRATTO" "SORKIN">>
...
She starts to open the " D ,ENVELOPE ", thinks better of it and hands it back to you. \"Will you open it up and read it to me?\" she pleads. \"I'll never find my glasses in this mess.\"">
		      ...
		      (T
		       ...
		       <ARTICLE ,PRSO T>
		       <TELL D ,PRSO 
" and hands it back. \"You keep it, dear. I've ">
		       <COND (<EQUAL? ,PRSO ,BOOK>
			      <TELL "a feeling you're going to need it." CR>
			      <RTRUE>)>
		       <TELL "got enough junk already.\"">)>
		<CRLF>
		<RTRUE>)
...
<ROUTINE READ-LETTER ("OPT" (ALOUD <>))
	<COND (<ZERO? .ALOUD>
	       <TELL "You study the quirky handwriting.||">)>
	<TELL 
"\"Deliver the Magick Stone to me before the moons sets, or you will never see your cat again!|
|
      The Evil One\"" CR>
	<RTRUE>>
...
<ROUTINE READ-LETTER-TO-WOMAN ()
	 <COND (,LETTER-READ-TO-WOMAN?
		...
		<UPDATE-SCORE 1>
		<TELL
"You smooth the letter out, clearing your throat nervously.||">
		<READ-LETTER T>
		<CRLF>
		<SAY-THE ,OLD-WOMAN>
...
|
\"The moon will set at six tomorrow morning. Return the cat to me by then, and " ,GAME " shall be yours.|
|
